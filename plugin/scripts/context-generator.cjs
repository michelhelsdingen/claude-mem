...
`+JSON.stringify(o,null,2):u=" "+this.formatData(o));let l="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,..._}=n;Object.keys(_).length>0&&(l=` {${Object.entries(_).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let g=`[${i}] [${a}] [${d}] ${c}${s}${l}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},m=new G;var Rt={};function Ot(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ce.fileURLToPath)(Rt.url))}var Ct=Ot(),R=I.get("CLAUDE_MEM_DATA_DIR"),W=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,de.homedir)(),".claude"),Wt=(0,b.join)(R,"archives"),Yt=(0,b.join)(R,"logs"),Vt=(0,b.join)(R,"trash"),qt=(0,b.join)(R,"backups"),Kt=(0,b.join)(R,"modes"),Jt=(0,b.join)(R,"settings.json"),me=(0,b.join)(R,"claude-mem.db"),zt=(0,b.join)(R,"vector-db"),Qt=(0,b.join)(R,"observer-sessions"),Zt=(0,b.join)(W,"settings.json"),es=(0,b.join)(W,"commands"),ts=(0,b.join)(W,"CLAUDE.md");function ue(r){(0,pe.mkdirSync)(r,{recursive:!0})}function le(){return(0,b.join)(Ct,"..")}var $=class{db;constructor(e=me){e!==":memory:"&&ue(R),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
...
`}function tt(r,e,t,s){let n=[];return s?n.push(...Be(r)):n.push(...Ae(r)),s?n.push(...He()):n.push(...Me()),s?n.push(...Ge()):n.push(...ve()),s?n.push(...We()):n.push(...Le()),P(t)&&(s?n.push(...Ye(e,t)):n.push(...De(e,t))),n}var ee=M(require("path"),1);function B(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return m.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function rt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function nt(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function st(r,e){return ee.default.isAbsolute(r)?ee.default.relative(e,r):r}function it(r,e,t){let s=B(r);if(s.length>0)return st(s[0],e);if(t){let n=B(t);if(n.length>0)return st(n[0],e)}return"General"}function At(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ot(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Mt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?B(r.facts).join(`
`):null}function vt(r,e,t,s,n,o){let i=[];o?i.push(...Ve(r)):i.push(...xe(r));let a=null,d="",c=!1;for(let u of e)if(u.type==="summary"){c&&(i.push(""),c=!1,a=null,d="");let l=u.data,g=rt(l.displayTime);o?i.push(...ze(l,g)):i.push(...we(l,g))}else{let l=u.data,g=it(l.files_modified,n,l.files_read),E=nt(l.created_at),T=E!==d,h=T?E:"";d=E;let _=t.has(l.id);if(g!==a&&(c&&i.push(""),o?i.push(...qe(g)):i.push(...ke(g)),a=g,c=!0),_){let S=Mt(l,s);o?i.push(...Je(l,E,T,S,s)):(c&&!o&&(i.push(""),c=!1),i.push(...$e(l,h,S,s)),a=null)}else o?i.push(Ke(l,E,T,s)):i.push(Ue(l,h,s))}return c&&i.push(""),i}function at(r,e,t,s,n){let o=[],i=At(r);for(let[a,d]of i)o.push(...vt(a,d,e,t,s,n));return o}function dt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function pt(r,e){let t=[];return e?(t.push(...x("Investigated",r.investigated,p.blue)),t.push(...x("Learned",r.learned,p.yellow)),t.push(...x("Completed",r.completed,p.green)),t.push(...x("Next Steps",r.next_steps,p.magenta))):(t.push(...D("Investigated",r.investigated)),t.push(...D("Learned",r.learned)),t.push(...D("Completed",r.completed)),t.push(...D("Next Steps",r.next_steps))),t}function ct(r,e){return e?Qe(r):Pe(r)}function mt(r,e,t){return!P(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Ze(r.totalDiscoveryTokens,r.totalReadTokens):Fe(r.totalDiscoveryTokens,r.totalReadTokens)}var Lt=ut.default.join((0,lt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Dt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,_t.unlinkSync)(Lt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function xt(r,e){return e?et(r):je(r)}function kt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...tt(r,d,s,i));let c=t.slice(0,s.sessionCount),u=Ne(c,t),l=Z(e,u),g=Ie(e,s.fullObservationCount);a.push(...at(l,g,s,n,i));let E=t[0],T=e[0];dt(s,E,T)&&a.push(...pt(E,i));let h=Q(e,s,o,n);return a.push(...ct(h,i)),a.push(...mt(d,s,i)),a.join(`
`).trimEnd()}async function te(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=Te(s),o=r?.projects||[n],i=Dt();if(!i)return"";try{let a=o.length>1?Ce(i,o,t):J(i,n,t),d=o.length>1?Re(i,o,t):z(i,n,t);return a.length===0&&d.length===0?xt(n,e):kt(n,a,d,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
